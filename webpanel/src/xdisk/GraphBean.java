...
public class GraphBean {
	...
	/*public Graph getMenuGraph() {
        ...
        if (menuGraph == null) {
            Node root = new Node("Menu 2", "Menpublic Graph getMenuGraph() {
        // Construct a preconfigured customer list lazily.
        if (menuGraph == null) {
...
u", null, null, false, true);
	...
	public Graph getTreeGraph() {
		...
		if (treeGraph == null) {
			Node root = new Node("Menu 4", "Menu 4", "folder_16_pad.gif", null, false, true);
			treeGraph = new Graph(root);

			Node file = new Node("File", "File 4", "/demo-test.faces", "folder_16_pad.gif",
					true, true);
			root.addChild(file);
			file.addChild(
					new Node("File-New", "New 4", "/demo-test.faces", "folder_16_pad.gif", true,
							false));
			file.addChild(
					new Node("File-Open",
							"Open 4",
			...
			Node edit = new Node("Edit", "Edit 4", "/demo-test.faces",  "folder_16_pad.gif",
					true, false);
			root.addChild(edit);
			edit.addChild(
					new Node("Edit-Cut", "Cut 4", "/demo-test.faces",  "folder_16_pad.gif", true,
							false));
			edit.addChild(
					new Node("Edit-Copy",
							"Copy 4",
							...
							false));
			edit.addChild(
					new Node("Edit-Paste", "Paste 4", "/demo-test.faces", "folder_16_pad.gif",
							false, false));
